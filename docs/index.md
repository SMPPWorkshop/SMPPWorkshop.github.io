...
<script>
  document.documentElement.classList.add("has-loader-js");
</script>

<div id="page-loader" aria-hidden="true">
  <div class="loader-core">
    <span class="loader-ring"></span>
    <p>Loading workshop page...</p>
  </div>
</div>
...
<section class="section-block intro-block">
  <div class="section-heading section-heading-featured">
    <h2 class="section-major-title">Introduction</h2>
    <p class="section-subtitle">Why this workshop matters</p>
  </div>
...
<section class="section-block">
  <div class="section-heading section-heading-featured">
    <h2 class="section-major-title">Call for Papers</h2>
...
<script>
  (function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      window.setTimeout(markLoaded, 2200);
    });
  })();
</script>
